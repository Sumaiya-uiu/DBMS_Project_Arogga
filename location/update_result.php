...
<?php
	...
	$query 	= "UPDATE location SET name='$name', postal_code='$postal' WHERE id = '$id'";
	...
	echo "<p style='color:green;margin-left:30px;margin-top:250px;text-align:center;font-size:25px;font-weight:780;font-family: arial'>RECORD UPDATED</p>";
