...
<?php
	...
	mysqli_query( $connect, "DELETE FROM location WHERE id='$id'" )

		or die("Can not execute query");


echo "<p style='green:red;margin-left:30px;margin-top:250px;text-align:center;font-size:25px;font-weight:780;font-family: arial'>RECORD DELETED</p>";
