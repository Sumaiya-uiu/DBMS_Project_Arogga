...
<?php
	...
	$query 	= "UPDATE company SET name='$name' WHERE com_id = '$id'";
...
echo "<p style='color:blue;margin-left:30px;margin-top:250px;text-align:center;font-size:25px;font-weight:780;font-family: arial'>RECORD UPDATED</p>";
