...
<?php
	...
	mysqli_query( $connect, "DELETE FROM disease WHERE d_id='$id'" )

		or die("Can not execute query");


echo "<p style='color:red;margin-left:30px;margin-top:250px;text-align:center;font-size:25px;font-weight:780;font-family: arial'>RECORD DELETED</p>";
